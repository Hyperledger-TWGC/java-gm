...
public class SM4Interation {
    ...
    public void sm4Interaction() throws Exception {
        ...
        byte[] b = instance.decrypt(ByteUtils.fromHexString(cryptText), key, SM4ModeAndPaddingEnum.SM4_CBC_PKCS7Padding, iv);
        ...
        byte[] cryptData = instance.encrypt(msg, key, SM4ModeAndPaddingEnum.SM4_CBC_PKCS7Padding, iv);
